...
## [0.5.3](https://github.com/sandeepyadav1478/deepagents/compare/deepagents==0.5.2...deepagents==0.5.3) (2026-04-11)
...
* **sdk:** add system prompt snapshot test with sync and async subagents ([#2072](https://github.com/sandeepyadav1478/deepagents/issues/2072)) ([98874f5](https://github.com/sandeepyadav1478/deepagents/commit/98874f577f80524b47f6031f761870e1547c0645))
* **sdk:** add tau2 airline eval harness ([#1987](https://github.com/sandeepyadav1478/deepagents/issues/1987)) ([610b19f](https://github.com/sandeepyadav1478/deepagents/commit/610b19fa79d39e32f28464462235406430f65ceb))
* **sdk:** add tau2 LICENSE ([#2025](https://github.com/sandeepyadav1478/deepagents/issues/2025)) ([650cedb](https://github.com/sandeepyadav1478/deepagents/commit/650cedb21d638a77559f7ac034c8524178460f28))
* **sdk:** add timestamp tracking to `AsyncSubAgentJob` ([#2071](https://github.com/sandeepyadav1478/deepagents/issues/2071)) ([93aa3cf](https://github.com/sandeepyadav1478/deepagents/commit/93aa3cf16dedeec7d97834d5ea6dcd65cd4c6256))
...
* **sdk:** bump recursion limit to 10_000 in deepagents and set agent name ([#2194](https://github.com/sandeepyadav1478/deepagents/issues/2194)) ([7dbc251](https://github.com/sandeepyadav1478/deepagents/commit/7dbc25180e05261fba4d5ec752d3052fbc826e4c))
...
* **sdk:** overwrite `write` on LangSmithSandbox ([#2097](https://github.com/sandeepyadav1478/deepagents/issues/2097)) ([c492a76](https://github.com/sandeepyadav1478/deepagents/commit/c492a7697e390ae760945d06ca4e824c4f47cf92))
...
* **sdk:** route subagent model resolution to `resolve_model` ([#2208](https://github.com/sandeepyadav1478/deepagents/issues/2208)) ([6720e4c](https://github.com/sandeepyadav1478/deepagents/commit/6720e4c520295ac1cb24c19cf3d315d2d05ba257))
* **sdk:** simplify memory agent bench evals ([#1873](https://github.com/sandeepyadav1478/deepagents/issues/1873)) ([a5d577d](https://github.com/sandeepyadav1478/deepagents/commit/a5d577d4871290272878137e1ffabc904402c10a))
* **sdk:** update middleware order ([#2070](https://github.com/sandeepyadav1478/deepagents/issues/2070)) ([def526b](https://github.com/sandeepyadav1478/deepagents/commit/def526b9621ee3c9e10b723acceb532341395554))
...
* **sdk:** use Sequence instead of list for subagents parameter ([#1905](https://github.com/sandeepyadav1478/deepagents/issues/1905)) ([b6f015e](https://github.com/sandeepyadav1478/deepagents/commit/b6f015e6178d1bf7bf470d049dbbf544e3a0ac94))
