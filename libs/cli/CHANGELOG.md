...
## [0.0.38](https://github.com/sandeepyadav1478/deepagents/compare/deepagents-cli==0.0.37...deepagents-cli==0.0.38) (2026-04-11)


### Features

* **ci:** include version in workflow run name ([#2627](https://github.com/sandeepyadav1478/deepagents/issues/2627)) ([336ffd8](https://github.com/sandeepyadav1478/deepagents/commit/336ffd88821114bcbde7408c49483770f0a758b9))
* **cli:** `--skill` startup invocation ([#2477](https://github.com/sandeepyadav1478/deepagents/issues/2477)) ([5f0f1d4](https://github.com/sandeepyadav1478/deepagents/commit/5f0f1d4605de1f1545846e2dbcc29a24c6f138d7))
...
* **cli:** `deepagents deploy` ([#2491](https://github.com/sandeepyadav1478/deepagents/issues/2491)) ([01dc60e](https://github.com/sandeepyadav1478/deepagents/commit/01dc60e394ecb56bd5336e447d32caeed8a67ec2))
...
* **cli:** add permissions to deepagents deploy ([#2651](https://github.com/sandeepyadav1478/deepagents/issues/2651)) ([5d93b73](https://github.com/sandeepyadav1478/deepagents/commit/5d93b736af6ffb165f33569233d533ced95a6943))
...
* **cli:** warn on missing tavily key, add `/notifications` ([#2555](https://github.com/sandeepyadav1478/deepagents/issues/2555)) ([3dff3ed](https://github.com/sandeepyadav1478/deepagents/commit/3dff3ed6835eae9f8b420b8a73c054127faaf7d2))
...
* **cli:** add missing model provider deps to deploy bundler [closes [#2647](https://github.com/sandeepyadav1478/deepagents/issues/2647)] ([#2660](https://github.com/sandeepyadav1478/deepagents/issues/2660)) ([b710a69](https://github.com/sandeepyadav1478/deepagents/commit/b710a69b12e49479045eaa54dfb709326473500b))
* **cli:** align headless todo guidance with non-interactive mode ([#2459](https://github.com/sandeepyadav1478/deepagents/issues/2459)) ([281899b](https://github.com/sandeepyadav1478/deepagents/commit/281899bf1932f959f512f94f4c2ac5d76ad32ecb))
* **cli:** bug w/ `AGENTS.md` in system prompt twice ([#2652](https://github.com/sandeepyadav1478/deepagents/issues/2652)) ([9052be9](https://github.com/sandeepyadav1478/deepagents/commit/9052be98d9f4ef9b11a88c9b1df3fae5e5ac666c))
...
* **cli:** dismiss slash command autocomplete on space ([#2478](https://github.com/sandeepyadav1478/deepagents/issues/2478)) ([02e46bc](https://github.com/sandeepyadav1478/deepagents/commit/02e46bc4cc470d93f5ab3ca05252ef1ffe87c3e7))
...
* **cli:** fail fast on missing provider credentials ([#2554](https://github.com/sandeepyadav1478/deepagents/issues/2554)) ([50fb8ae](https://github.com/sandeepyadav1478/deepagents/commit/50fb8aefe7e3065024e10f1d5ecd11a54d736641))
* **cli:** fix mktemp template in debug script for macOS ([#2603](https://github.com/sandeepyadav1478/deepagents/issues/2603)) ([63fa537](https://github.com/sandeepyadav1478/deepagents/commit/63fa537e9995ca2ead492ee44902227567e9a130))
* **cli:** guard against textual cursor/document desync crash ([#2494](https://github.com/sandeepyadav1478/deepagents/issues/2494)) ([c14a748](https://github.com/sandeepyadav1478/deepagents/commit/c14a7483ed92428ec2241dd8254cdab9c26a6a4f))
* **cli:** harden deploy config parsing and add unit tests ([#2636](https://github.com/sandeepyadav1478/deepagents/issues/2636)) ([0469d14](https://github.com/sandeepyadav1478/deepagents/commit/0469d1429d129e604fc1b622263923162f719314))
...
* **cli:** load project .env before deploy/dev config validation ([#2644](https://github.com/sandeepyadav1478/deepagents/issues/2644)) ([8299091](https://github.com/sandeepyadav1478/deepagents/commit/829909166606f8a9d9571b00da725845bad08da7))
...
* **cli:** resolve conflicting langsmith env var precedence ([#2455](https://github.com/sandeepyadav1478/deepagents/issues/2455)) ([b6997d8](https://github.com/sandeepyadav1478/deepagents/commit/b6997d830c8c2822acbaa0ad672bdec873af2b9d))
...
* **cli:** show server startup error instead of generic agent message ([#2397](https://github.com/sandeepyadav1478/deepagents/issues/2397)) ([a3e1e93](https://github.com/sandeepyadav1478/deepagents/commit/a3e1e9365178ad14d7233ae577bb87d714daff5c))
...
* **cli:** sort MCP tools deterministically for prompt-cache stability ([#2497](https://github.com/sandeepyadav1478/deepagents/issues/2497)) ([39b43cf](https://github.com/sandeepyadav1478/deepagents/commit/39b43cf8d0f44827f3b2faf32843c7db436539e8))
* **cli:** stop loading widget timer leak ([#2396](https://github.com/sandeepyadav1478/deepagents/issues/2396)) ([01d3d86](https://github.com/sandeepyadav1478/deepagents/commit/01d3d864098c4e96527082b2bd1755ac6591b098))
