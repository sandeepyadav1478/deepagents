...
## [0.1.0](https://github.com/sandeepyadav1478/deepagents/compare/deepagents-cli==0.0.32...deepagents-cli==0.1.0) (2026-03-13)
...
* **cli:** `/compact` command ([#1579](https://github.com/sandeepyadav1478/deepagents/issues/1579)) ([46e9e95](https://github.com/sandeepyadav1478/deepagents/commit/46e9e950087e973175d49d6a863cfa9d2f241528))
...
* **cli:** add `--profile-override` CLI flag ([#1605](https://github.com/sandeepyadav1478/deepagents/issues/1605)) ([1984099](https://github.com/sandeepyadav1478/deepagents/commit/1984099ae9ac4b0c13dc08722abb9d56055da7b7))
...
* **cli:** add background PyPI update check ([#1648](https://github.com/sandeepyadav1478/deepagents/issues/1648)) ([2e7a5e7](https://github.com/sandeepyadav1478/deepagents/commit/2e7a5e7d97f64147ab2d000fae833fe681f1d6b2))
...
* **cli:** add curl-pipe-bash install script ([#1649](https://github.com/sandeepyadav1478/deepagents/issues/1649)) ([68f6ef9](https://github.com/sandeepyadav1478/deepagents/commit/68f6ef96e7d66b2c98d1371e91e5d25f107b80fe))
...
* **cli:** add fuzzy search to model switcher ([#1266](https://github.com/sandeepyadav1478/deepagents/issues/1266)) ([a6bbb18](https://github.com/sandeepyadav1478/deepagents/commit/a6bbb182a2336ba748d93a06b9fcf27966321e20))
...
* **cli:** add model profile overrides to config ([#1603](https://github.com/sandeepyadav1478/deepagents/issues/1603)) ([d3d6899](https://github.com/sandeepyadav1478/deepagents/commit/d3d6899209b7cf97447da0eee642b3f55261ffbc))
* **cli:** add model usage stats display ([#1587](https://github.com/sandeepyadav1478/deepagents/issues/1587)) ([a1208db](https://github.com/sandeepyadav1478/deepagents/commit/a1208db096761eb54e0fe712a5aa922502575cb6))
...
* **cli:** add substring matching to command history navigation ([#1301](https://github.com/sandeepyadav1478/deepagents/issues/1301)) ([e276d5a](https://github.com/sandeepyadav1478/deepagents/commit/e276d5a64bee9394f53ab993b01447023bcd4c7d))
...
* **cli:** fuzzy search for slash command autocomplete ([#1660](https://github.com/sandeepyadav1478/deepagents/issues/1660)) ([5f6e9c0](https://github.com/sandeepyadav1478/deepagents/commit/5f6e9c014e6a99783b3113184cc12f0179a902f0))
...
* **cli:** show summarization status and notification    ([#919](https://github.com/sandeepyadav1478/deepagents/issues/919)) ([2e3cb74](https://github.com/sandeepyadav1478/deepagents/commit/2e3cb743eff8e0a33b215359132cee13a673a4df))
...
* **cli:** add missing flags to help screen ([#1619](https://github.com/sandeepyadav1478/deepagents/issues/1619)) ([6067749](https://github.com/sandeepyadav1478/deepagents/commit/60677492b3f49adc8535b34156029271a0728923))
* **cli:** align compaction messaging across `/compact` and `compact_conversation` ([#1583](https://github.com/sandeepyadav1478/deepagents/issues/1583)) ([d455a6b](https://github.com/sandeepyadav1478/deepagents/commit/d455a6b117dbca2dfb5156050273a84946adc247))
...
* **cli:** allow Esc to exit command/bash input mode ([#1644](https://github.com/sandeepyadav1478/deepagents/issues/1644)) ([906da72](https://github.com/sandeepyadav1478/deepagents/commit/906da72ea40e16492f8e7f3c35758af486c92b3c))
...
* **cli:** apply profile overrides in `/compact` ([#1612](https://github.com/sandeepyadav1478/deepagents/issues/1612)) ([a9dc2c5](https://github.com/sandeepyadav1478/deepagents/commit/a9dc2c5a1ad6d37f3f682491664b3f709cad8552))
...
* **cli:** backspace at cursor position 0 exits mode even with text ([#1666](https://github.com/sandeepyadav1478/deepagents/issues/1666)) ([dfa4c1f](https://github.com/sandeepyadav1478/deepagents/commit/dfa4c1fedcecf2bb17d8ffef01cf50efe6c80fb0))
* **cli:** coerce execute timeout to int before formatting tool display ([#1588](https://github.com/sandeepyadav1478/deepagents/issues/1588)) ([04b8c72](https://github.com/sandeepyadav1478/deepagents/commit/04b8c72361f7eb60b86fa560ef3f6283912c3395)), closes [#1586](https://github.com/sandeepyadav1478/deepagents/issues/1586)
...
* **cli:** disambiguate `/tokens` vs `/compact` token reporting ([#1618](https://github.com/sandeepyadav1478/deepagents/issues/1618)) ([51c3347](https://github.com/sandeepyadav1478/deepagents/commit/51c3347e5a402115d4ecbb09f0074c607270f992))
...
* **cli:** image path pasting qualms ([#1560](https://github.com/sandeepyadav1478/deepagents/issues/1560)) ([8caaf3e](https://github.com/sandeepyadav1478/deepagents/commit/8caaf3e71ae7f5a26c20ca86700cc51f3c6f37ed))
...
* **cli:** load `.agents` skill alias directories at interactive startup ([#1556](https://github.com/sandeepyadav1478/deepagents/issues/1556)) ([af0a759](https://github.com/sandeepyadav1478/deepagents/commit/af0a759ee231cfe8860da34fe39dbcff38726102))
...
* **cli:** make `!` bash commands interruptible via `Esc`/`Ctrl+C` ([#1638](https://github.com/sandeepyadav1478/deepagents/issues/1638)) ([0c414d1](https://github.com/sandeepyadav1478/deepagents/commit/0c414d154a74cfabebfae8fc2dbb6d7e39da3857))
* **cli:** make escape reject pending HITL approval first ([#1645](https://github.com/sandeepyadav1478/deepagents/issues/1645)) ([5d7be0c](https://github.com/sandeepyadav1478/deepagents/commit/5d7be0c1a2fbe54f7fe062c5a43a7591aecb00e4))
* **cli:** make langsmith URL lookups non-blocking ([#1595](https://github.com/sandeepyadav1478/deepagents/issues/1595)) ([572eaee](https://github.com/sandeepyadav1478/deepagents/commit/572eaeefbe2f9318555733977e4771815879273c))
...
* **cli:** prevent cwd overflow in status bar when mode indicator is visible ([#1647](https://github.com/sandeepyadav1478/deepagents/issues/1647)) ([89717e2](https://github.com/sandeepyadav1478/deepagents/commit/89717e2e43c23703953bf0eb6d449135d0c93259))
...
* **cli:** retry langsmith project url lookup until project exists ([#1562](https://github.com/sandeepyadav1478/deepagents/issues/1562)) ([e137a63](https://github.com/sandeepyadav1478/deepagents/commit/e137a633fdadda205b8e05a9fdabc4b978726a37))
...
* **cli:** show cwd on startup ([#1209](https://github.com/sandeepyadav1478/deepagents/issues/1209)) ([23032dd](https://github.com/sandeepyadav1478/deepagents/commit/23032ddd80b0ec8bf58c91776e62b834f6e03b5e))
...
* **cli:** show model info in `/tokens` before first usage ([#1607](https://github.com/sandeepyadav1478/deepagents/issues/1607)) ([7b01ae7](https://github.com/sandeepyadav1478/deepagents/commit/7b01ae7258ed079046262d1c174f1c406101294c))
...
* **cli:** skip usage table when no model was called ([#1640](https://github.com/sandeepyadav1478/deepagents/issues/1640)) ([0a7db73](https://github.com/sandeepyadav1478/deepagents/commit/0a7db73a3edacd4d3689091248a87a9eaf709899))
...
* **cli:** support space-separated tokens in model fuzzy search ([#1636](https://github.com/sandeepyadav1478/deepagents/issues/1636)) ([6179a96](https://github.com/sandeepyadav1478/deepagents/commit/6179a96400fb000298e0ed3ef7aa839e89fdffa5))
...
* **cli:** terminate active subprocesses on app quit ([#1646](https://github.com/sandeepyadav1478/deepagents/issues/1646)) ([5f2e614](https://github.com/sandeepyadav1478/deepagents/commit/5f2e614f05912d3278a988cb7366612099105acf))
...
* **cli:** use first-class OpenRouter attribution kwargs ([#1635](https://github.com/sandeepyadav1478/deepagents/issues/1635)) ([9c1ed93](https://github.com/sandeepyadav1478/deepagents/commit/9c1ed93861a52b9ced2c1426131d542f50afa623))
...
* **sdk,cli,deps:** support `timeout=0` for sandbox `execute()` ([#1558](https://github.com/sandeepyadav1478/deepagents/issues/1558)) ([ed14443](https://github.com/sandeepyadav1478/deepagents/commit/ed14443b5aec8afde1f74bb2e12a17cb7d1829b6))
...
* **cli:** optimize thread resume path with prefetch and batched hydration ([#1561](https://github.com/sandeepyadav1478/deepagents/issues/1561)) ([068d112](https://github.com/sandeepyadav1478/deepagents/commit/068d1128177de0f0a01f533a01184039c2a2f09f))
* **cli:** parallelize detect script for faster first-turn ([#1541](https://github.com/sandeepyadav1478/deepagents/issues/1541)) ([dad8b6e](https://github.com/sandeepyadav1478/deepagents/commit/dad8b6e15a78d26921c0cb831579648927caa551))
...
* **cli:** speed up `/threads` first-open ([#1481](https://github.com/sandeepyadav1478/deepagents/issues/1481)) ([b248b15](https://github.com/sandeepyadav1478/deepagents/commit/b248b15fd70de3c4d055b68a0dae04f00e41ea9e))
